...
So this app learns your range from your own data and reports everything relative to that. When it says a stretch was "above your baseline", it means above your own typical level for that session — not above some universal standard.
...
**Peaks** are stretches where focus stayed meaningfully above your baseline for at least three minutes. The app looks for sustained stretches rather than instants, because a single high reading is noise and three minutes of them is a pattern.

**Slumps** are the same idea downwards: at least four minutes meaningfully below your baseline.
